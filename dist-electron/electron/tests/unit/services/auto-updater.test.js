...
vi.mock('electron', () => ({
    ...
    dialog: {
        showMessageBox: vi.fn().mockImplementation(() => Promise.resolve(mockDialogResponse)),
    },
    BrowserWindow: vi.fn(),
}));
...
describe('AutoUpdaterService', () => {
    ...
    beforeEach(() => {
        ...
        service = new AutoUpdaterService(mockWindow);
    });
    /**
    ...
    describe('Constructor', () => {
        it('should create an instance with a main window', () => {
            const svc = new AutoUpdaterService(mockWindow);
    ...
    describe('setMainWindow()', () => {
        it('should update main window reference', () => {
            ...
            service.setMainWindow(newWindow);
    ...
    describe('dispose()', () => {
        ...
        it('should clear initial check timeout', () => {
            ...
            const checkMessages = consoleSpy.info.filter((msg) => msg.includes('Checking'));
    ...
    describe('Update Flow', () => {
        describe('onUpdateAvailable (simulated)', () => {
            ...
            it('should handle destroyed window gracefully', async () => {
                ...
                const onUpdateAvailable = service.onUpdateAvailable.bind(service);
                // Should not throw
                await expect(onUpdateAvailable({ version: '2.0.0' })).resolves.not.toThrow();
        ...
        describe('onUpdateDownloaded (simulated)', () => {
            ...
            it('should handle destroyed window gracefully', async () => {
                ...
                // @ts-expect-error - accessing private method for testing
                const onUpdateDownloaded = service.onUpdateDownloaded.bind(service);
                await expect(onUpdateDownloaded({ version: '2.0.0' })).resolves.not.toThrow();
                expect(dialog.showMessageBox).not.toHaveBeenCalled();
            });
        });
    });
    ...
    describe('Edge Cases', () => {
        ...
        it('should handle check errors gracefully', async () => {
            ...
            // Restore
            app.getVersion.mockImplementation(originalGetVersion);
        });
