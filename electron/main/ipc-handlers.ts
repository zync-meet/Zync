...
/**
 * Interface defining the structure of download platform request data.
 *
 * This interface ensures that all download requests contain the required
 * information and helps TypeScript catch errors at compile time.
 *
 * @interface DownloadPlatformData
 * @property {string} platform - The target platform identifier
 */
interface DownloadPlatformData {
    /** The target platform ('win', 'mac', or 'linux') */
    platform: string;
}

/**
 * Interface for application information returned by the 'get-app-info' handler.
 *
 * @interface AppInfo
 * @property {string} version - Application version from package.json
 * @property {string} name - Application name
 * @property {string} electronVersion - Electron framework version
 * @property {string} chromeVersion - Chrome/Chromium version
 * @property {string} nodeVersion - Node.js runtime version
 * @property {string} v8Version - V8 JavaScript engine version
...
/**
 * Type alias for valid platform values, derived from the VALID_PLATFORMS array.
 *
 * @typedef {typeof VALID_PLATFORMS[number]} ValidPlatform
 */
